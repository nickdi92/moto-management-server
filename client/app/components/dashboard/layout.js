...
import {GetNavigationMenuItems, classNames, IsCurrentRoute, GetUserNavigationItems} from "@/app/helpers/utils";
...
if (userInfo || userInfo.status_code === 200) {
    user = {
...
export default function DashboardHeader({
    ...
    const [navItems, setNavItems] = useState(GetNavigationMenuItems());
    useEffect(() => {
        navItems.map((navItem) => {
            if (IsCurrentRoute(navItem.href)) {
                navItem["current"] = true;
            }
            return navItem
        });
        return () =>  setNavItems(navItems)
    }, [navItems])
    return (
        <>
            {
                            ...
                            <div className="hidden md:block">
                                <div className="ml-4 flex items-center md:ml-6">
                                    ...
                                    <Menu as="div" className="relative ml-3">
                                        ...
                                        >
                                            {GetUserNavigationItems().map((item) => (

...
import {GetUserFullName, GetUsername, IsUserLoggedIn} from "@/app/helpers/userHelper";
...
function getNavigationUrl(navigationName) {
    let url = navigation.filter((nav) => {
...
let user = {};
let userInfo = await GetUserInfo({username: GetUsername()})
...
export default function Dashboard() {
    ...
    if (!IsUserLoggedIn()) {
        ...
        let motorcyclesNode = userInfo.user.motorcycles;
